...
$paths = [
    ...
    ['google/firefoxlocales/release/', 200, '["an","as","az","bn-IN","br","ca","cs","cy","da","de","dsb","en-GB","en-ZA","eo","es-AR","es-ES","es-MX","et","eu","fi","ff","fr","fy-NL","ga-IE","gd","gl","gu-IN","hi-IN","hr","hsb","hu","hy-AM","id","is","it","ja","kk","kn","ko","lt","lv","mai","ml","mr","ms","my","nb-NO","nl","or","pa-IN","pl","pt-BR","pt-PT","ro","ru","sk","sl","son","sq","sv-SE","ta","te","th","tr","uk","uz","zh-CN","zh-TW"]'],
