...
$paths = [
    ...
    ['v1/fx_android/supportedlocales/release/', 200, '["an","ar","as","ast","az","bn-IN","br","ca","cak","cs","cy","da","de","dsb","en-GB","en-ZA","eo","es-AR","es-CL","es-ES","es-MX","et","eu","fa","ff","fi","fr","fy-NL","ga-IE","gd","gl","gn","gu-IN","he","hi-IN","hr","hsb","hu","hy-AM","id","is","it","ja","ka","kk","kn","ko","lt","lv","mai","ml","mr","ms","my","nb-NO","nl","nn-NO","or","pa-IN","pl","pt-BR","pt-PT","rm","ro","ru","sk","sl","son","sq","sr","sv-SE","ta","te","th","tr","uk","ur","uz","xh","zh-CN","zh-TW"]'],
