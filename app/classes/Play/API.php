 ...
 * api/<service>/
 *
 * Example for the list of locales supported by Google Play:
 * /api/googleplay/locales/
 *
 * List of services:
 * googleplay:        Return translations for all locales of a Mozilla entity
 * locale/ab-CD:  Return all the locales supported for a repository
 *
 * @package Play
 */
Class API
