...
class Project
{
     ...
     *
     * For Apple see also https://docs.fastlane.tools/actions/appstore/#available-language-codes
    ...
    public $templates = [
        'fx_android' => [
            'release' => [
                ...
                'whatsnew' => 'fx_android/whatsnew/android_62.lang',
            ],
            'beta' => [
                'template' => 'fx_android/beta/listing_may_2015.php',
                'listing'  => 'fx_android/description_beta.lang',
                'whatsnew' => 'fx_android/whatsnew/android_63.lang',
            ],
            'nightly' => [
        ...
        'fx_ios' => [
            'release' => [
                ...
                'whatsnew' => 'fx_ios/whatsnew/ios_14.lang',
            ],
        ],
        'focus_ios' => [
            'release' => [
