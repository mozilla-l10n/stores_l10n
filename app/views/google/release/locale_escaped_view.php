...
<pre><?= $app_title2($translations) ?></pre>
...
<pre contenteditable="true"><em><?= $short_desc($translations) ?></em></pre>
...
<pre style="text-align: center;" contenteditable="true"><?= htmlspecialchars(strip_tags($screenshots($translations))) ?></pre>
